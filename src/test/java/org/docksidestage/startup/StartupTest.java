 ...
 * @author jflute
 */
public class StartupTest extends UnitOnparadeTestCase {
    ...
    public void test_startup_actually() throws Exception {
        ...
        startupLogic.toOnparade(getProjectDir(), domain, serviceName);
        refresh(serviceName); // for retry
    }

    protected void refresh(String serviceName) {
        try {

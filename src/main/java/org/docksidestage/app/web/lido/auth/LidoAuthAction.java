...
import org.docksidestage.app.web.base.OnparadeBaseAction;
 ...
 * @author jflute
 */
public class LidoAuthAction extends OnparadeBaseAction {
    ...
    private void moreValidate(SignupBody body, OnparadeMessages messages) {
    ...
    private void sendSignupMail(SignupBody body, String signupToken) {
        WelcomeMemberPostcard.droppedInto(postbox, postcard -> {
            postcard.setFrom(config.getMailAddressSupport(), "Onparade Support"); // #simple_for_example

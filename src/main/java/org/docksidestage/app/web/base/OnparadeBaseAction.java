...
import org.docksidestage.app.web.base.login.OnparadeLoginAssist;
import org.docksidestage.app.web.base.view.HeaderBean;
import org.docksidestage.mylasta.action.OnparadeHtmlPath;
import org.docksidestage.mylasta.action.OnparadeMessages;
import org.docksidestage.mylasta.action.OnparadeUserBean;
 ...
 * @author jflute
 */
public abstract class OnparadeBaseAction extends TypicalAction // has several interfaces for direct use
        implements LaValidatable<OnparadeMessages>, OnparadeHtmlPath {
    ...
    @Resource
    private OnparadeLoginAssist loginAssist;
    ...
    @Override
    protected OptionalThing<OnparadeUserBean> getUserBean() { // application may call, overriding for co-variant
    ...
    @Override
    public ActionValidator<OnparadeMessages> createValidator() { // for co-variant
        return super.createValidator();
    }

    @Override
    public OnparadeMessages createMessages() { // application may call
        return new OnparadeMessages(); // overriding to change return type to concrete-class
    }

...
import org.docksidestage.mylasta.direction.OnparadeConfig;
 ...
 * @author jflute
 */
public class OnparadeLoginAssist extends TypicalLoginAssist<Integer, OnparadeUserBean, Member> // #change_it also UserBean
    ...
    //                                                                       =============
    @Override
    protected OnparadeUserBean createUserBean(Member userEntity) {
        return new OnparadeUserBean(userEntity);
    }

    @Override
    protected OptionalThing<String> getCookieRememberMeKey() {
        return OptionalThing.of(config.getCookieRememberMeOnparadeKey());
    }
    ...
    @Override
    protected void saveLoginHistory(Member member, OnparadeUserBean userBean, LoginSpecifiedOption option) {
        asyncManager.async(() -> {
    ...
    //                                                                      ==============
    @Override
    protected Class<OnparadeUserBean> getUserBeanType() {
        return OnparadeUserBean.class;
    }

 ...
 * @author jflute
 */
public class OnparadeSecurityResourceProvider implements SecurityResourceProvider {
    ...
    public OnparadeSecurityResourceProvider(InvertibleCryptographer primaryInvertibleCryptographer,

 ...
 * @author jflute
 */
public class OnparadeCurtainBeforeHook implements CurtainBeforeHook {
    ...
    protected DfFinalTimeZoneProvider createFinalTimeZoneProvider() {
        return new DfFinalTimeZoneProvider() {
            protected final TimeZone provided = OnparadeUserTimeZoneProcessProvider.centralTimeZone;

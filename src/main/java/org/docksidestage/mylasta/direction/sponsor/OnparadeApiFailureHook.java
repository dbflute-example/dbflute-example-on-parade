 ...
 * @author jflute
 */
public class OnparadeApiFailureHook implements ApiFailureHook { // #change_it for handling API failure
    ...
    public static class TooSimpleFailureResult {
        ...
        public final String notice = "[Attension] tentative JSON so you should change it: " + OnparadeApiFailureHook.class;
        @Required

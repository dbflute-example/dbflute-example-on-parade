 ...
 * @author jflute
 */
public class OnparadeCookieResourceProvider implements CookieResourceProvider {

    protected final OnparadeConfig config;
    protected final InvertibleCryptographer cookieCipher;

    public OnparadeCookieResourceProvider(OnparadeConfig config, InvertibleCryptographer cookieCipher) {
        this.config = config;

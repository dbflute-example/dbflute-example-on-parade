...
public class OnparadeMessages extends OnparadeLabels {
     ...
     * @return this. (NotNull)
     */
    public OnparadeMessages addConstraintsDigitsMessage(String property, String integer, String fraction) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public OnparadeMessages addConstraintsModCheckMessage(String property, String value, String modType) {
        assertPropertyNotNull(property);
